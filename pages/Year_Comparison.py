...
st.subheader('Data from ' + month + ' 2021 vs 2022 vs 2023')
st.write('Total Returns 2021: ' + str(df_2021['Quantity'].sum()))
...
st.header('Total Returns for the Year 2021, 2022, and 2023')
